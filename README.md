...
[![My Skills](https://skillicons.dev/icons?i=js,html,css,wasm,ae,aws,cloudflare,docker,gcp,github,git,ai,kubernetes,linkedin,linux,mysql,nginx,ps,postman,powershell,rasberrypi,visualstudio,vscode,wordpress)](https://skillicons.dev)
